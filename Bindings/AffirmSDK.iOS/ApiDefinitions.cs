...
namespace AffirmSDK
{
	...
	interface AffirmJSONifiable
	{
		...
		NSMutableDictionary ToJSONDictionary { get; }
	}

	interface IAffirmJSONifiable { }

	// @interface AffirmBillingDetail : NSObject <AffirmJSONifiable, NSCopying>
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmBillingDetail : IAffirmJSONifiable, INSCopying
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmCheckout : IAffirmJSONifiable, INSCopying
	{
	...
	interface AffirmClientProtocol
	{
		...
		[Static]
		[Export ("send:handler:")]
		void Handler (AffirmRequestProtocol request, AffirmRequestHandler handler);
	}

	interface IAffirmClientProtocol { }

	// @interface AffirmTrackerClient : NSObject <AffirmClientProtocol>
	[BaseType (typeof(NSObject))]
	interface AffirmTrackerClient : IAffirmClientProtocol
	{
	}

	// @interface AffirmPromoClient : NSObject <AffirmClientProtocol>
	[BaseType (typeof(NSObject))]
	interface AffirmPromoClient : IAffirmClientProtocol
	{
	}

	// @interface AffirmCheckoutClient : NSObject <AffirmClientProtocol>
	[BaseType (typeof(NSObject))]
	interface AffirmCheckoutClient : IAffirmClientProtocol
	{
	}
	...
	interface AffirmPromotionalButton_Helper
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmDiscount : IAffirmJSONifiable, INSCopying
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmItem : IAffirmJSONifiable, INSCopying
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull name;
		[Export ("name")]
		string Name { get; }
	...
	[BaseType (typeof(NSObject))]
	interface AffirmOrder : IAffirmJSONifiable, INSCopying
	{
	...
	[BaseType (typeof(NSObject))]
	interface AffirmProduct : IAffirmJSONifiable, INSCopying
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmLogRequest : IAffirmRequestProtocol
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmPromoRequest : IAffirmRequestProtocol
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull publicKey;
		[Export ("publicKey")]
		string PublicKey { get; }
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmCheckoutRequest : IAffirmRequestProtocol
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull publicKey;
		[Export ("publicKey")]
		string PublicKey { get; }
	...
	[BaseType (typeof(NSObject))]
	interface AffirmPromoResponse : IAffirmResponseProtocol
	{
	...
	[BaseType (typeof(NSObject))]
	interface AffirmCheckoutResponse : IAffirmResponseProtocol
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmErrorResponse : IAffirmResponseProtocol
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface AffirmShippingDetail : IAffirmJSONifiable, INSCopying
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull name;
		[Export ("name")]
		string Name { get; }
